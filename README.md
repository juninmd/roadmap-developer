...
1. **Linting & Formatting**: Checks code quality with ESLint, MarkdownLint, and Prettier.
2. **Testing**: Runs unit tests using Vitest with a minimum of 80% coverage and end-to-end (E2E) tests with Playwright.
3. **Build**: Generates the static VitePress site.
4. **Deploy**: Deploys automatically to GitHub Pages when merged into the `main` branch.

**Badges:**
[![CI/CD Pipeline](https://github.com/roadmap-developer-community/roadmap-developer-2026/actions/workflows/ci.yml/badge.svg)](https://github.com/roadmap-developer-community/roadmap-developer-2026/actions/workflows/ci.yml)
