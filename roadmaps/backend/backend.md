...
- **[Práticas de Cloud (AWS Skill Builder)](https://explore.skillbuilder.aws/):** Plataforma oficial da AWS com recursos focados em Serverless e práticas de nuvem para escalar arquiteturas plenas, com uma introdução a FinOps.
