...
- **Server Actions (Avançado):** Lógica que roda no servidor a partir do frontend, útil para mutações em bancos de dados ou chamadas de API, garantindo segurança ao invés de expor endpoints.
