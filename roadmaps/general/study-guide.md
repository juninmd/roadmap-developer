...
- **Desenvolvimento de Aplicativos com TypeScript:** Aprender tipagem forte como padrão para prevenir erros silenciosos (erros de `null` ou `undefined`) em tempo de compilação, focando em Interfaces e Generics.
...
- **IA Literacy:** [Microsoft: Generative AI for Beginners](https://github.com/microsoft/generative-ai-for-beginners). Ferramentas como **Cursor** e **GitHub Copilot** também são excelentes pontos de partida.
